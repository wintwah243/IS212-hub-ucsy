# The Problem of "Too Much" Information (slide 6,7,8 - 14.6.2026)
...
## Slide 8: Practical Exercise (The Shortcut in Action)

This slide uses a math problem to show how these patterns save a computer from doing unnecessary work.

**The Scenario:** Imagine a database with only two customers:
Customer 1 bought 100 items (a1 to a100).
Customer 2 bought 50 items (a1 to a50).

**Rule:** To be "frequent," a pattern must appear at least once (min_sup=1).

ပုစ္ဆာရဲ့ ပေးထားချက် (Given Database) -
- Transaction 1 (Customer 1): {a1, a2, a3, ....., a100} — (ပစ္စည်း ၁၀၀ ခု ဝယ်ယူ)
- Transaction 2 (Customer 2): {a1, a2, a3, ....., a50} — (ပစ္စည်း ၅၀ ခု ဝယ်ယူ)
- သတ်မှတ်ချက် (minsup): >= 1 (databaseထဲမှာ အနည်းဆုံး ၁ ကြိမ် ပါဝင်ရုံဖြင့် Frequent ဟု သတ်မှတ်မယ်)

**The Results:**
**Closed Frequent Itemsets:** There are only two.
- The group of 100 items (which appears once).
- The group of 50 items (which appears twice).
- Why? Because no larger group has these exact counts.

**Maximal Frequent Itemsets:** There is only one.
- The group of 100 items.
- Why? Because every other combination (like the group of 50 items) is just a subset of this largest group of 100.

**The "All Patterns" Problem:**
- If you didn't use these shortcuts and tried to list every possible frequent combination, you would have 2^100 −1 results (roughly 1 nonillion).
...
- closed patternနဲ့ max-pattern က datasetများတာနဲ့အမျှ storageပြသာနာကိုဖြေရှင်းဖို့သုံးတာ။
