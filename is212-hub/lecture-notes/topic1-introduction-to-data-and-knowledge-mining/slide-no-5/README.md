...
- Evaluationမှာ Subjective နဲ့ Objective ဆိုပြီး ရှိ။ 
  ...
  Objective Metrics: ဒါက ကိုယ့်ဘက်က ပြောသလို Standard Metrics (စံနှုန်းဂဏန်းတွေ) နဲ့ တိုင်းတာတာ ဖြစ်တယ်။ လူရဲ့ ပုဂ္ဂိုလ်စွဲ ခံစားချက်မပါဘဲ သင်္ချာနည်းအရ သေချာတွက်ချက်ထားတဲ့ ဂဏန်းတွေ (ဥပမာ- Accuracy ဘယ်လောက် % ရှိလဲ) ပေါ်မှာပဲ မူတည်ပြီး ဆုံးဖြတ်တာပါ။
